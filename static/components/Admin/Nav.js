              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown d-flex" style="margin-right: 100px;">
                  ...
                  <ul class="dropdown-menu" >
                    <li><router-link to='/admin/dashboard/ManagerRequest' class="dropdown-item">Manager Request</router-link></li> 
                     <li><hr class="dropdown-divider"></li>
                    <li><router-link to='/admin/dashboard/requests' class="dropdown-item">Requests</router-link></li> 
